...
fs.writeFileSync(dataFile, JSON.stringify({ tables: { users: { data: [] }, organization_memberships: { data: [] } } }), 'utf8');
const fixtureSource = `
const users = [
