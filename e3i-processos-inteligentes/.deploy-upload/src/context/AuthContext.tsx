...
export type ViewName = 'landing' | 'dashboard' | 'tools' | 'smartQuotation' | 'obligationsPanel' | 'accessRequests' | 'tenants' | 'users' | 'rbac' | 'audit' | 'designSystem' | 'architecture' | 'organizationSettings' | 'discovery' | 'discoveryReview' | 'businessContext' | 'strategyCanvas' | 'organizationMap' | 'systems';
