-- Baseline histórico para reconstrução local do Supabase.
-- NÃO editar para mudanças novas: toda alteração posterior deve entrar em sql/migrations/.
-- Este arquivo foi congelado a partir do schema existente quando o pipeline de schema reprodutível foi introduzido.
