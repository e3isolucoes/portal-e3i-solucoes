...
const ENTITY_CONFIG = Object.freeze({
  profiles: { prefix: 'PROFILE', grant: 'obrigacoes', writeGrant: 'administracao', read: ['member', 'manager', 'admin', 'super_admin'], create: ['admin', 'super_admin'], write: ['member', 'manager', 'admin', 'super_admin'] },
